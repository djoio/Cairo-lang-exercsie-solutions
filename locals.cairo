func main():
    ...
    # tempvar automatically increments the ap register, this throws off alloc_locals when we call it below, because it also increments the ap register we get the error 
